...
namespace PSXPackager
{
    public class Options
    {
        ...
        [Option("extract-resources", Required = false, HelpText = "If specified, extract resources into %FILENAME%\\%RESOURCE%%EXT% by default. See README for more details.")]
        public string ExtractResources { get; set; }

        [Option("import-resources", Required = false, HelpText = "If specified, import resources from %FILENAME%\\%RESOURCE%%EXT% by default. See README for more details.")]
        public string ImportResources { get; set; }

        [Option("generate-resource-folders", Required = false, HelpText = "If specified, create empty resources folder %FILENAME% by default. See README for more details.")]
