...
.PHONY:	build-gui-win-x64 build-win-x64 build-linux-x64 build-linux-arm build-osx-x64 build-osx-arm64
build:
...
.PHONY:	clean-gui-win-x64 clean-win-x64 clean-linux-x64 clean-linux-arm clean-osx-x64 clean-osx-arm64
clean:	clean-gui-win-x64 clean-win-x64 clean-linux-x64 clean-linux-arm clean-osx-x64 clean-osx-arm64
...
build-linux-x64 build-linux-arm build-osx-x64 build-osx-arm64:
	$(eval RID := $(subst build-,,$(@)))
...
clean-win-x64 clean-linux-x64 clean-linux-arm clean-osx-x64 clean-osx-arm64:
